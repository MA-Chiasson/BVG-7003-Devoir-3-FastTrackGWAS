...
- [2. Data Download and Preparation](#2-data-download-and-preparation)  
  ...
  - [2.2. Other Data Recommendations](#22-other-data-recommendations)  
...
- [5. Loading Data in R](#5-loading-data-in-r)  
  ...
  - [5.2. Optional Input: Kinship and PCA Data](#52-optional-input-kinship-and-pca-data)  
- [6. Data Preprocessing](#6-data-preprocessing)  
  - [6.1. Quality Control](#61-quality-control)  
    - [6.1.1. Genotype Data Quality Control](#611-genotype-data-quality-control)  
    - [6.1.2. Phenotype Data Quality Control](#612-phenotype-data-quality-control)  
  - [6.2. Generating Covariates](#62-generating-covariates)  
...
- [9. Expected Results from This Pipeline with the Example Data](#9-expected-results-from-this-pipeline-with-the-example-data)  
  - [9.1. Single- vs. Multi-Trait Results](#91-single--vs-multi-trait-results)  
  - [9.2. Output Files Generated](#92-output-files-generated)  
    - [Q-Q Plots](#q-q-plots)  
    - [Manhattan Plots](#manhattan-plots)  
    - [Significant SNP Filtering](#significant-snp-filtering)  
