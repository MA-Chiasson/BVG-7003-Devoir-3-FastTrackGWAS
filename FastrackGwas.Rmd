...
# 4. Filtering SNPs with too low MAF (default <1%), as well as rows containing too many NAs (default >10%)
...
```{r}
filter_hapmap <- function(hapmap_data, freq_threshold = 1, na_threshold = 10) {
